...
<div class="position-relative sidernw" style="height:100vh;margin:0 auto;margin-bottom: 0px;">
                    ...
                    <div class="cover">
                        <div class="container">
                            <div class="header-content">
                                <div class="line"></div>
                                <h2>Understated Elegance with a <br>Contemporary Edge</h2>
		...
		<section class="full-row bg-white interior" style="z-index: 99;">
			<div class="container">
				<div class="row">				
					<div class="col-lg-12">
						<div class="main-title-area text-center">
							<h2 class="title left-right-line mb-3">Interior</h2>
							<p><h6 class="" style="animation-delay: 0.2s;">MY Giorgia can accommodate up to ten guests in five well-appointed staterooms, all featuring ensuite marble bathrooms. </h6>
							...
							Classically designed interiors and minimalist dark wood bulkheads contribute to a contemporary ambience, while plush furnishings create a sense of warmth, elegance and comfort.</p></p>
						</div>
			
						
						<div class="row">
						<div class="col-lg-4">
							<div class="image-inter">
							<img src="{{ asset('images/interior/1.jpg') }}" alt="Image not found!">
							</div>
						</div>
						<div class="col-lg-4">
						<div class="image-inter">
							<img src="{{ asset('images/interior/2.jpg') }}" alt="Image not found!">
							</div>
						</div>
						<div class="col-lg-4">
						<div class="image-inter">
							<img src="{{ asset('images/interior/3.jpg') }}" alt="Image not found!">
							</div>
						</div>
					</div>
					<div class="text-center items-end mt-4">
		...
		<!-- Living Room 2 Section Start -->
		<section class="full-row bg-grey bg-colorone exterior" style="z-index: 99;">
			<div class="container">				
				<div class="row">
					<div class="col-lg-12">
						<div class="main-title-area text-center">
							<h2 class="title left-right-line mb-3">Exterior</h2>
							<p><h6 class="" style="animation-delay: 0.2s;" > Giorgia is a true masterpiece of high-end yachting design, featuring teak beams and elegant, no-fuss exteriors. Wherever you are going you can rest assured that you will arrive in style.</h6>
							...
							With a choice of three decks, all featuring their own dining space, you can savour your meals al fresco, sip cocktails under the starry sky at the sundeck bar, or indulge in strawberries and champagne while soaking in the spa pool.</p></p>
						</div>
						<div class="row">
						<div class="col-lg-4">
							<div class="image-inter">
							<img src="{{ asset('images/exterior/01.jpg') }}" alt="Image not found!">
							</div>
						</div>
						<div class="col-lg-4">
						<div class="image-inter">
						<img src="{{ asset('images/exterior/2.jpg') }}" alt="Image not found!">
							</div>
						</div>
						<div class="col-lg-4">
						<div class="image-inter">
						<img src="{{ asset('images/exterior/3.jpg') }}" alt="Image not found!">
							</div>
						</div>
						</div>
						<div class="text-center items-end mt-4">
