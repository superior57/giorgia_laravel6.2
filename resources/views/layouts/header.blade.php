...
<header class="full-row header-1 nav-on-banner" id="header">
    ...
    <div class="navbar-header">
        <div class="container">
            <div class="row">
                <nav class="navbar navbar-expand-lg navbar-light w-100"> <a class="navbar-brand" href="{{ url('/') }}"><img class="nav-logo" src="img/logo/logo4.png" alt="logo"></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item {{ Request::segment(1) === 'welcome' ? 'active' : '' }}"><a href="{{ url('/') }}" class="nav-link">Home</a></li>
                            <li class="nav-item {{ Request::segment(1) === 'vessel' ? 'active' : '' }}"><a href="{{ url('/vessel') }}" class="nav-link">Vessel</a></li>
                            <li class="nav-item {{ Request::segment(1) === 'experience' ? 'active' : '' }}"><a href="{{ url('/experience') }}" class="nav-link">Experience</a></li>
                            <li class="nav-item {{ Request::segment(1) === 'crew' ? 'active' : '' }}"><a href="{{ url('/crew') }}" class="nav-link">Crew</a></li>
                            <li class="nav-item {{ Request::segment(1) === 'booking' ? 'active' : '' }}"><a href="{{ url('/booking') }}" class="nav-link">Enquire</a></li>
